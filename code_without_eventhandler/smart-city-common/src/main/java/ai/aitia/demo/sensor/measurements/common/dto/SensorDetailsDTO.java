...
public class SensorDetailsDTO implements Serializable{
	...
	//-------------------------------------------------------------------------------------------------
	private SensorDetailsDTO(final Builder builder) {
	...
	public static class Builder {
		...
		//-------------------------------------------------------------------------------------------------
		public SensorDetailsDTO build() {
			return new SensorDetailsDTO(this);
		}
	}	
}
