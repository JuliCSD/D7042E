package ai.aitia.demo.sensor_measurements.weather_sensors.controller;
...
import ai.aitia.demo.sensor_measurements.weather_sensors.service.WeatherService;
...
public class WeatherServiceController {
	...
	//-------------------------------------------------------------------------------------------------
	@GetMapping(path = EFCommonConstants.WEATHER_SENSOR_DETAILS_SERVICE_URI)
	@ResponseBody public SensorDetailsListDTO getWeatherSensorDetails(@RequestParam(name = EFCommonConstants.REQUEST_PARAM_BUILDING) final long building,
		...
		return weatherService.getHourlySensorDetails(building, fromTimestamp, toTimestamp);
	}
}