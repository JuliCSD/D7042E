...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO weatherTempService = createServiceRegistryRequest(EFCommonConstants.WEATHER_SENSOR_DETAILS_SERVICE, EFCommonConstants.WEATHER_SENSOR_DETAILS_SERVICE_URI, HttpMethod.GET);
		weatherTempService.getMetadata().put(EFCommonConstants.REQUEST_PARAM_KEY_BUILDING, EFCommonConstants.REQUEST_PARAM_BUILDING);
		weatherTempService.getMetadata().put(EFCommonConstants.REQUEST_PARAM_KEY_FROM, EFCommonConstants.REQUEST_PARAM_FROM);
		weatherTempService.getMetadata().put(EFCommonConstants.REQUEST_PARAM_KEY_TO, EFCommonConstants.REQUEST_PARAM_TO);
		arrowheadService.forceRegisterServiceToServiceRegistry(weatherTempService);
		logger.info("Service registered: {}", EFCommonConstants.WEATHER_SENSOR_DETAILS_SERVICE);
	}
	...
	public void customDestroy() {
		//Unregister service
		arrowheadService.unregisterServiceFromServiceRegistry(EFCommonConstants.WEATHER_SENSOR_DETAILS_SERVICE, EFCommonConstants.WEATHER_SENSOR_DETAILS_SERVICE_URI);
		logger.info("Service unregistered: {}", EFCommonConstants.WEATHER_SENSOR_DETAILS_SERVICE);
	}
