...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO weatherTempService = createServiceRegistryRequest(EFCommonConstants.LIGHT_SENSOR_DETAILS_SERVICE, EFCommonConstants.LIGHT_SENSOR_DETAILS_SERVICE_URI, HttpMethod.GET);
		...
		logger.info("Service registered: {}", EFCommonConstants.LIGHT_SENSOR_DETAILS_SERVICE);
	}
	...
	public void customDestroy() {
		//Unregister service
		arrowheadService.unregisterServiceFromServiceRegistry(EFCommonConstants.LIGHT_SENSOR_DETAILS_SERVICE, EFCommonConstants.LIGHT_SENSOR_DETAILS_SERVICE_URI);
		logger.info("Service unregistered: {}", EFCommonConstants.LIGHT_SENSOR_DETAILS_SERVICE);
	}
