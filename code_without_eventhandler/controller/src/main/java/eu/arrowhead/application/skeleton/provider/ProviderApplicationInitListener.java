...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO sensorService = createServiceRegistryRequest(EFCommonConstants.SENSOR_MEASUREMENTS_SERVICE, EFCommonConstants.SENSOR_MEASUREMENTS_SERVICE_URI, HttpMethod.GET);
		sensorService.getMetadata().put(EFCommonConstants.REQUEST_PARAM_KEY_BUILDING, EFCommonConstants.REQUEST_PARAM_BUILDING);
		sensorService.getMetadata().put(EFCommonConstants.REQUEST_PARAM_KEY_TIMESTAMP, EFCommonConstants.REQUEST_PARAM_TIMESTAMP);
		arrowheadService.forceRegisterServiceToServiceRegistry(sensorService);
		logger.info("Service registered: {}", EFCommonConstants.SENSOR_MEASUREMENTS_SERVICE);
	}
	...
	public void customDestroy() {
		//Unregister service
		arrowheadService.unregisterServiceFromServiceRegistry(EFCommonConstants.SENSOR_MEASUREMENTS_SERVICE, EFCommonConstants.SENSOR_MEASUREMENTS_SERVICE_URI);
		logger.info("Service unregistered: {}", EFCommonConstants.SENSOR_MEASUREMENTS_SERVICE);
	}
