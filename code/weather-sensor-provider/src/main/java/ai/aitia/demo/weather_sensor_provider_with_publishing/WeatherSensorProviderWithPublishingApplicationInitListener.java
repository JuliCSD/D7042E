...
public class WeatherSensorProviderWithPublishingApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		getWeatherSensorServiceRequest.getMetadata().put(WeatherSensorProviderWithPublishingConstants.REQUEST_PARAM_KEY_VALUE, WeatherSensorProviderWithPublishingConstants.REQUEST_PARAM_VALUE);
